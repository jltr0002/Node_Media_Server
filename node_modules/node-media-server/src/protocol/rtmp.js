...
const vodHandler = require("../services/vod_handler.js");
const liveDashHandler = require("../services/live_dash_handler.js");
...
class Rtmp {
  ...
  onPublish = (invokeMessage) => {
    ...
    console.log(`StreamName}: ${this.streamName}, StreamId: ${this.streamId}, StreamApp: ${this.streamApp}`);
    
    if (this.streamApp === "video") {
      vodHandler(this.streamName);
    } else if (this.streamApp === "stream") {
      liveDashHandler(this.streamName);
    } else {
      // For /live, no additional processing is needed.
    }
