...
class NodeHttpServer {
  constructor(config) {
    ...
    const clientPath = path.join(__dirname, '../../../../shaka_client');
    ...
    app.use((req, res, next) => {
      if (req.url.endsWith('.mpd'))   res.type('application/dash+xml');
      else if (req.url.endsWith('.m4s')) res.type('video/iso.segment');
      next();
    });
    ...
    app.use(
      ...
      serveIndex(clientPath, { icons: true })
    );   
